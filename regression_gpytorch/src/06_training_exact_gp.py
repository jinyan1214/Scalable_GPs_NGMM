...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_training_eqs', type=int, default=50,
    ...
    parser.add_argument('--num_training_iter', type=int, default=2500,
    ...
    trained_model_dir = os.path.join(output_dir, 'trained_models', f'Exact_gp_{num_training_eqs}_training_eqs')
    ...
    for i in training_tqdm:
        ...
        training_tqdm.set_postfix(loss=f"{loss.item():.4f}",
                                noise=f"{likelihood.noise.item():.4f}")
